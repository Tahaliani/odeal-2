...
class PaymentDenied extends StatefulWidget {
  const PaymentDenied({Key? key}) : super(key: key);

  @override
  _PaymentDeniedState createState() => _PaymentDeniedState();
}

class _PaymentDeniedState extends State<PaymentDenied> {
                      ...
                      child: Center(
                          child: Container(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    Image(
                                      image:AssetImage("assets/icons/denied.png"),
                                      height:100,
